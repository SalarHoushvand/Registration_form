...
The following ``get-component-policy`` example displays the details of a component policy by specifying its ARN. ::

    aws imagebuilder get-component-policy --image-arn arn:aws:imagebuilder:us-west-2:123456789012:component/my-example-component/2019.12.03/1
